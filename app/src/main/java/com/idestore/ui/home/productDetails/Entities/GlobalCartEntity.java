...
@Entity(tableName = "GlobalCartTable",indices = @Index(value = {"Pid"}, unique = true))
public class GlobalCartEntity {
    ...
    @Ignore
    public GlobalCartEntity(int pid, String pname, String actual_price,String p_price, String oldprice, int quantity,String photo, String stock,
        ...
        this.stock=stock;this.catEntityLocalArrayList=catEntityLocalArrayList;this.quantity=quantity;
    }

   public GlobalCartEntity(int auto_id,int pid,String pname,String actual_price,String p_price,String oldprice,int quantity,String photo,String stock,
                     ArrayList<DesCatEntityLocal>catEntityLocalArrayList){
